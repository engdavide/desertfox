let panel1Select = document.querySelector('select[name="opp[panel1]"]');
let coverage1Select = document.querySelector('select[name="opp[panel1Coverage]"]');

let panel2Select = document.querySelector('select[name="opp[panel2]"]');
let coverage2Select = document.querySelector('select[name="opp[panel2Coverage]"]');

let custNumSelect = document.querySelector('input[name="opp[custNum]"]');
